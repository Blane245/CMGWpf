...
namespace CMGWpf.SoundFont_2
{
    ...
    {
        public static readonly InstrumentRegion Default = new InstrumentRegion();
        ...
        public static InstrumentRegion[] Create(Instrument instrument, Span<Zone> zones, SampleHeader[] samples)
        {
        ...
        public short this[GeneratorType generatortType] => gs[(int)generatortType];
