...
// This library was extracted from sinshu/MeltySynth to include only the soundFont file components
namespace CMGWpf.SoundFont_2
{
    ...
    public sealed class SoundFont
    {
        ...
        public short[] WaveDataArray => waveData;
        public SampleHeader[] SampleHeaderArray => sampleHeaders;
        public Preset[] PresetArray => presets;
        public Instrument[] InstrumentArray => instruments;
    }
}
