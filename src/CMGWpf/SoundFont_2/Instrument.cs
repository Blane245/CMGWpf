...
namespace CMGWpf.SoundFont_2
{
    ...
    {
        public static readonly Instrument Default = new Instrument();
        ...
        public static Instrument[] Create(InstrumentInfo[] infos, Zone[] zones, SampleHeader[] samples)
        {
            if (infos.Length <= 1)
            {
        ...
        public InstrumentRegion[] RegionArray => regions;
    }
}
