    ...
    public static class AudioBuffer
    {
        ...
        public static double[] Add(double[] inputBuffer, double[] outputBuffer, int location)
        {
            ...
            if (excessLength > 0)
            {
                ...
                DebugLog.Write($"AudioBuffer: Info - Audio extended by {excessLength} samples (input length={inputBuffer.Length}, location={location}, new output length={outputBuffer.Length}, time={(double)excessLength / 44100})");
            }
